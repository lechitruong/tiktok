...
export const getPostsSelector = (state:RootState): PostModel[] => state.post.posts
export const postSelector = (state:RootState): InitStatePostType | null => state.post
export const postUploadSelector = (state:RootState): PostUploadModel | null => state.post.postUpload
