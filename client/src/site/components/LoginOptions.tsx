  ...
  return (
    <div className='flex flex-col items-center w-full'>
        ...
        <div className='w-full max-h-[460px]'>
          <ButtonAuth icon={<FaRegUserCircle fontSize={20}  />}  text='Use phone / email / username' onClick={()=>{window.location.href = "/login-email";}}></ButtonAuth>
